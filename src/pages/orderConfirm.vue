<template>
    <div class="order-confirm">
        ...
        <modal
            ...
            @cancel="showEditModal=false;getAddressList();"
    ...
    export default {
        ...
        methods: {
            ...
            submitAddress(){
                ...
                let methods,url,params={};
                if(userAction == 0){ // 新增
                    methods = 'post',url = '/shippings';
                }else if(userAction == 1){ // 修改
                    methods = 'put',url = `/shippings/${checkedItem.id}`;
                }else{ // 删除
                    methods = 'delete',url = `/shippings/${checkedItem.id}`;
                }
                // 新增和修改时，提交参数
